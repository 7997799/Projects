<%@ Page Title="" Language="C#" MasterPageFile="~/Viewer.master" AutoEventWireup="true" CodeFile="detail1.aspx.cs" Inherits="detail" %>
                                   ...
                                   <video width="200" height="150"  poster=' <%# Eval("poster") %>'   runat="server">
									  ...
									  <div class="mid-1">
										...
										<div class="mid-2">
											...
											<p><%# Eval("v_desc") %></p>
												  <asp:Button ID="Button1" runat="server" Text="Subscribe" CommandName="buy" CommandArgument='<%# Eval("Id") %>' />	
